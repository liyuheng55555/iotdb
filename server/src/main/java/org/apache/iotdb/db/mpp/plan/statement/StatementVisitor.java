...
public abstract class StatementVisitor<R, C> {
  ...
  public R visitExplainLogicalPlan(
      ExplainLogicalPlanStatement explainLogicalPlanStatement, C context) {
    return visitStatement(explainLogicalPlanStatement, context);
  }
