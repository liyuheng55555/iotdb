...
utilityStatement
    : merge | fullMerge | flush | clearCache | settle | explain | explainLogicalPlan
...
explainLogicalPlan
    : EXPLAINLOGICALPLAN selectStatement
    ;
...
expression
    ...
    | leftExpression=expression POWER rightExpression=expression
